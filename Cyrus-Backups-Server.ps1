...
if ($dayOfWeek -eq "Monday") {
    ...
    Backup-VM -vmNames "ad3" -hypervisorName $Isaac -backupDirectory "$target\ad3-daily"
}
...
Cleanup-Backups -BackupName "AD3-Daily" -DaysOldToKeep 7 -BackupFolder "V:\VM_Backup\ad3-daily"
Cleanup-Backups -BackupName "Xibo" -DaysOldToKeep 31 -BackupFolder "$backupDir\xibo"

. "$PSScriptRoot\Scripts\Build-WebSite.ps1"
